...
namespace CourseRegistrationSystem.Controllers
{
    public class EnrollmentsController : Controller
    {
        ...
        public IActionResult Create()
        {
            ...
            ViewData["StudentId"] = new SelectList(_context.Set<Student>(), "Id", "Email");
            return View();
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,StudentId,CourseId")] Enrollment enrollment)
        {
            ...
            ViewData["CourseId"] = new SelectList(_context.Courses, "Id", "Description", enrollment.CourseId);
            ViewData["StudentId"] = new SelectList(_context.Set<Student>(), "Id", "Email", enrollment.StudentId);
            return View(enrollment);
        }
